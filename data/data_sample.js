...
var dataModule = (function () {
    ...
    maturityLevels = [
        ...
        {score: -1, definition: 'Optimizing'},
        {score: 0, definition: 'Quantitatively Managed'},
        {score: 1, definition: 'Consistent'},
        {score: 2, definition: 'Repeatable'},
        {score: 3, definition: 'Regressive'}
    ];
    ...
    return {
        ...
        emptyDataSet: [
            [
                {'app': '', 'axis': categories[0], value: -2},
                {'app': '', 'axis': categories[1], value: -2},
                {'app': '', 'axis': categories[2], value: -2},
                {'app': '', 'axis': categories[3], value: -2},
                {'app': '', 'axis': categories[4], value: -2},
                {'app': '', 'axis': categories[5], value: -2}
            ]
        ],
